...
<div
	class="w-24 h-32 card opacity-80 {isRedSuit
		? 'text-red-500'
		: 'text-black'} backdrop-blur-2xl backdrop-brightness-50 bg-orange-400 opacity-70"
>
	<div class="text-xs font-bold my-2 text-white">UPGRADE {cardno}</div>
