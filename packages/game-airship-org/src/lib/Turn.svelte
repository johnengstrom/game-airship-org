...
<div
	class="card w-24 h-32 opacity-80 {isRedSuit
		? 'text-red-500'
		: 'text-black'} backdrop-blur-2xl backdrop-brightness-50 bg-green-800 opacity-70"
>
	<div class="text-xs font-bold my-2 text-white">TURN {cardno}</div>
