<script>
	export let width = '36'; // width is provided externally
    export let backgroundColor = 'rgba(255, 255, 255, 0.7)'; // default background color, can be overridden externally
...
>
	<defs id="defs20300">
		...
		<inkscape:path-effect effect="spiro" id="path-effect17935-9-8-2-5-08" />
		<inkscape:path-effect effect="spiro" id="path-effect17935-9-8-2-5-0-8" />
	</defs>
	<metadata id="metadata20303">
		<rdf:RDF>
			<cc:Work rdf:about="">
	...
	<g transform="translate(-151.42857,-248.08929)" id="layer1">
		<g transform="translate(151.42857,-264.27291)" id="g3026">
			<rect
